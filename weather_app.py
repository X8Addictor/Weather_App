...
def get_weather_clicked():
    ...
    today_lbl.configure(text = f"Today's Weather")
    ...
    img_panel.image = img
    img_panel.grid(column = 0, row = 2)

    forecast_weather = weather["forecast"]["forecastday"][0]["day"]
    ...
    fore_img_panel.grid(column = 0, row = 8)
...
if __name__ == "__main__":
    ...
    today_lbl.grid(column = 0, row = 1)

    cond_lbl = Label(app, text = "")
    cond_lbl.grid(column = 0, row = 3)
    temp_lbl = Label(app, text = "")
    temp_lbl.grid(column = 0, row = 4)
    wind_lbl = Label(app, text = "")
    wind_lbl.grid(column = 0, row = 5)
    humid_lbl = Label(app, text = "")
    humid_lbl.grid(column = 0, row = 6)

    separator_lbl = Label(app, text = " ")
    separator_lbl.grid(column = 0, row = 7)

    fore_cond_lbl = Label(app, text = "")
    fore_cond_lbl.grid(column = 0, row = 9)
    max_temp_lbl = Label(app, text = "")
    max_temp_lbl.grid(column = 0, row = 10)
    min_temp_lbl = Label(app, text = "")
    min_temp_lbl.grid(column = 0, row = 11)
    fore_wind_lbl = Label(app, text = "")
    fore_wind_lbl.grid(column = 0, row = 12)
    avg_humid_lbl = Label(app, text = "")
    avg_humid_lbl.grid(column = 0, row = 13)
    chance_rain_lbl = Label(app, text = "")
    chance_rain_lbl.grid(column = 0, row = 14)
